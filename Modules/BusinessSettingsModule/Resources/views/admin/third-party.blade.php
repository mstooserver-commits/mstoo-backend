                                                    ...
                                                    <div class="mb-30">
                                                        <div class="form-floating">
                                                            ...
                                                            <input type="password" class="form-control"
                                                                   name="server_key"
                                                                   placeholder="{{ !empty(bs_data($data_values,'push_notification')['server_key'] ?? null) ? translate('server_key_is_saved_enter_a_new_key_to_replace') : translate('server_key') }}"
                                                                   autocomplete="new-password"
                                                                   {{ empty(bs_data($data_values,'push_notification')['server_key'] ?? null) ? 'required' : '' }}>
