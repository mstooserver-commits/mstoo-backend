...
class CouponController extends Controller
{
    ...
    public function apply_coupon(Request $request): JsonResponse
    {
        ...
        } else if ($coupon->coupon_type == 'pro_member') {
            $proService = app(\Modules\ProMemberManagement\Services\ProMemberService::class);
            if (!$proService->couponBenefitEnabled($request->user()->id)) {
                return response()->json(response_formatter(COUPON_NOT_VALID_FOR_CART), 200);
            }
        }
