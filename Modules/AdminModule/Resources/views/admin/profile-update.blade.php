                                    ...
                                    <div class="col-md-6">
                                        <div class="radius-10 h-100">
                                            <div class="card-body">
                                                ...
                                                <div class="row gx-2">
                                                    <div class="col-lg-6">
                                                        <div class="form-floating mb-30">
                                                            ...
                                                            <label>{{translate('First_Name')}} <span class="required-star">*</span></label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-floating mb-30">
                                                            ...
                                                            <label>{{translate('Last_Name')}} <span class="required-star">*</span></label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-floating mb-30">
                                                ...
                                                <div class="form-floating mb-30">
                                                    <input oninput="this.value = this.value.replace(/[^+\d]+$/g, '').replace(/(\..*)\./g, '$1');" type="tel" class="form-control" name="phone" value="{{ old('phone', auth()->user()->phone) }}"
