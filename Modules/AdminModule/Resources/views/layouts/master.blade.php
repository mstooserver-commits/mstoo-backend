...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Public+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap"
        rel="stylesheet">
...
<script src="{{asset('assets/admin-module')}}/js/mstoo-admin.js"></script>
{!! Toastr::message() !!}
...
<script>
    setInterval(function () {
        var countEl = document.getElementById("message_count");
        if (!countEl) {
            return;
        }
        $.get({
            ...
            success: function (response) {
                if (response && response.data) {
                    countEl.innerHTML = response.data.message;
                }
            },
        });
    }, 20000);
