...
class BookingReportController extends Controller
{
    ...
    public function service_reported()
    {
        $service_reported=DB::table('reports')->get();
        // print_r($service_reported) or die();
        return view('adminmodule::admin.report.service_reported',compact('service_reported'));
    }
