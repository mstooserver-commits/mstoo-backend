...
class AdminController extends Controller
{
    ...
    public function dashboard(Request $request, Transaction $transaction): Application|Factory|View
    {
        ...
        $data[] = ['booking_cards' => [
            'pending' => $this->booking->where('booking_status', 'pending')->count(),
            'accepted' => $this->booking->where('booking_status', 'accepted')->count(),
            'ongoing' => $this->booking->where('booking_status', 'ongoing')->count(),
            'completed' => $this->booking->where('booking_status', 'completed')->count(),
            'canceled' => $this->booking->where('booking_status', 'canceled')->count(),
            'new_customers' => $this->user->where(['user_type' => 'customer'])
