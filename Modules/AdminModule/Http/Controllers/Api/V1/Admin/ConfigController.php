    ...
    public function config(): JsonResponse
    {
        return response()->json(response_formatter(DEFAULT_200, [
            ...
            'default_location' => ['default' => [
                'lat' => (float)(business_live('business_latitude', 'business_information', 23.812492) ?: 23.812492),
                'lon' => (float)(business_live('business_longitude', 'business_information', 90.368620) ?: 90.368620)
            ]],
            'app_url_android' => '',
            'app_url_ios' => '',
