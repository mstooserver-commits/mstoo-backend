...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'role', 'as' => 'role.', 'middleware' => ['mpc:employee_management,manage_roles']], function () {
        Route::get('list', 'RoleController@index')->name('index');
    ...
    Route::group(['prefix' => 'employee', 'as' => 'employee.', 'middleware' => ['mpc:employee_management']], function () {
        Route::any('list', 'EmployeeController@index')->name('index');
        Route::any('create', 'EmployeeController@create')->name('create')->middleware('mpc:employee_management,create');
        Route::post('store', 'EmployeeController@store')->name('store')->middleware('mpc:employee_management,create');
        Route::get('edit/{id}', 'EmployeeController@edit')->name('edit')->middleware('mpc:employee_management,edit');
        Route::put('update/{id}', 'EmployeeController@update')->name('update')->middleware('mpc:employee_management,edit');
        Route::any('status-update/{id}', 'EmployeeController@status_update')->name('status-update')->middleware('mpc:employee_management,edit');
        Route::delete('delete/{id}', 'EmployeeController@destroy')->name('delete')->middleware('mpc:employee_management,delete');
