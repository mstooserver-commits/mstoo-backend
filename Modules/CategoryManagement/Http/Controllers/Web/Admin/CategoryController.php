...
class CategoryController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $category->featured_price = $request->featured_price;
        // $category->image = file_uploader('category/', 'png', $request->file('image'));
        $category->image = file_uploader('category/', 'svg', $request->file('image'));
    ...
    public function update(Request $request, string $id): JsonResponse|RedirectResponse
    {
        ...
        if ($request->has('image')) {
            ...
            $category->image = file_uploader('category/', 'svg', $request->file('image'), $category->image);
        }
        $category->parent_id = 0;
        $category->featured_price = $request->featured_price;
        $category->position = 1;
