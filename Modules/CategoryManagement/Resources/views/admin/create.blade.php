                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="form-floating mb-30">
                                                <input type="text" name="featured_price" class="form-control"
                                                       value="{{old('featured_price')}}"
                                                       placeholder="{{translate('featured_price')}}" required>
                                                <label>{{translate('featured_price')}}</label>
                                            </div>

                                            <!-- hidden zone id for category zone -->
                                            <input type="hidden" name="zone_ids[]" value="{{$zones['0']['id']}}">
                                            ...
                                            <div>
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img onerror="this.src='{{asset('assets/admin-module/img/media/upload-file.png')}}'"
