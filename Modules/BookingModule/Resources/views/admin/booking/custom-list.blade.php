                                                            ...
                                                            <li>
                                                                <div class="media gap-3">
                                                                    <div class="avatar border rounded">
                                                                        <img src="{{asset('assets/admin-module')}}/img/avatar/serviceman.png" class="rounded" alt="">
                                                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-4 px-lg-4">
                                <div class="d-flex flex-column align-items-center">
                                    <img width="75" class="mb-3" src="{{asset('assets/admin-module')}}/img/icons/notification.png" alt="">
                                    ...
                                    <div class="mb-4 text-center d-flex flex-column align-items-center">
                                        <div class="avatar avatar-lg mb-2">
                                            <img class="rounded" src="{{asset('assets/admin-module')}}/img/avatar/serviceman.png" alt="">
                                        </div>
                                        <div>Jhone Doe</div>
                                    ...
                                    <div class="media gap-2 mb-4">
                                        <img width="30" src="{{asset('assets/admin-module')}}/img/media/appliance.png" alt="">
                                        <div class="media-body">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-4 px-lg-4">
                                <div class="media flex-column flex-sm-row flex-wrap gap-3">
                                    <img width="173" class="radius-10" src="{{asset('assets/admin-module')}}/img/avatar/serviceman.png" alt="">
                                    <div class="media-body">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-sm-5 px-sm-5">
                                <div class="d-flex flex-column align-items-center gap-2 text-center">
                                    <img src="{{asset('assets/admin-module')}}/img/icons/alert.png" alt="">
                                    <h3>Alert!</h3>
                                ...
                                <div class="card border">
                                    <div class="card-body">
                                        <div class="d-flex gap-4 mb-4">
                                            <div class="media gap-2">
                                                <div class="avatar avatar-lg rounded">
                                                    <img src="{{asset('assets/admin-module')}}/img/avatar/serviceman.png" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            <img width="18" src="{{asset('assets/admin-module')}}/img/media/edit-info.png" alt="">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="d-flex flex-column gap-2 align-items-center">
                                    <img width="75" class="mb-2" src="{{asset('assets/admin-module')}}/img/media/ignore-request.png" alt="">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="card bg-primary-light shadow-none">
                                    <div class="card-body pb-5">
                                        <div class="media flex-wrap gap-3">
                                            <img width="140" class="radius-10" src="{{asset('assets/admin-module')}}/img/avatar/serviceman.png" alt="">
                                            <div class="media-body">
                            ...
                            <div class="col-lg-6">
                                <div class="card bg-primary-light shadow-none">
                                    <div class="card-body pb-5">
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            <img width="18" src="{{asset('assets/admin-module')}}/img/media/more-info.png" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center gap-2 bg-primary-light shadow-none">
                                        <img width="18" src="{{asset('assets/admin-module')}}/img/icons/instruction.png" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center gap-2 bg-primary-light shadow-none">
                                        <img width="18" src="{{asset('assets/admin-module')}}/img/icons/edit-info.png" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center gap-2 bg-primary-light shadow-none">
                                        <img width="18" src="{{asset('assets/admin-module')}}/img/icons/provider.png" alt="">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body pb-4">
                                        <div class="d-flex justify-content-between gap-3 mb-4">
                                            ...
                                            <div>
                                                <img width="24" src="{{asset('assets/admin-module')}}/img/icons/chat.png" alt="">
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between gap-3 mb-4">
                                            <div class="media gap-3">
