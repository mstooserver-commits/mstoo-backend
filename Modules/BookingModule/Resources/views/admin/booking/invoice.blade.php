        ...
        <div style="min-width: 600px">
            ...
            <main>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    @if(($booking->total_pro_discount_amount ?? 0) > 0)
                    <tr>
                        <td colspan="2"></td>
                        <td colspan="2" class="text-uppercase">{{translate('pro_member_discount')}}</td>
                        <td>- {{with_currency_symbol($booking->total_pro_discount_amount)}}</td>
                    </tr>
                    @endif
                    @if(($booking->service_fee ?? 0) > 0)
                    <tr>
                        <td colspan="2"></td>
                        <td colspan="2" class="text-uppercase">{{translate('service_fee')}}</td>
                        <td>+ {{with_currency_symbol($booking->service_fee)}}</td>
                    </tr>
                    @endif
                    <tr>
                        <td colspan="2"></td>
