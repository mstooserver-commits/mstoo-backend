...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin', 'mpc:system_management']], function () {
    Route::group(['prefix' => 'configuration', 'as' => 'configuration.'], function () {
        ...
        Route::put('payment-set', [PaymentConfigController::class, 'payment_config_set'])->middleware('mpc:system_management,edit')->name('payment-set');
        Route::post('payment-test', [PaymentConfigController::class, 'payment_test'])->middleware('mpc:system_management,edit')->name('payment-test');
    });
});
