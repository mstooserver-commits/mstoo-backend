...
@section('content')
    <div class="main-content">
        <div class="container-fluid">
            ...
            <form action="{{route('admin.customer.store')}}" method="post" enctype="multipart/form-data" id="customer-add-form">
                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-30">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="first_name" placeholder="{{translate('first_name')}}" required value="{{old('first_name')}}">
                                            <label>{{translate('first_name')}} *</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-30">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="last_name" placeholder="{{translate('last_name')}}" required value="{{old('last_name')}}">
                                    ...
                                    <div class="col-md-6 mb-30">
                                        <div class="form-floating">
                                            <select class="form-control" name="gender">
                                                <option value="male" {{old('gender','male')=='male'?'selected':''}}>{{translate('male')}}</option>
                                                <option value="female" {{old('gender')=='female'?'selected':''}}>{{translate('female')}}</option>
                                                <option value="others" {{old('gender')=='others'?'selected':''}}>{{translate('others')}}</option>
                                            </select>
                    ...
                    <div class="card-body p-30">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-30">
                                ...
                                <small class="text-danger">* ( {{translate('country_code_required')}} )</small>
                            </div>
                        </div>
                    </div>
                </div>
