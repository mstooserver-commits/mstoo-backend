                ...
                <div class="card-body p-30">
                    <div class="row justify-content-center">
                        <div class="col-sm-6 col-md-8 col-lg-6 col-xl-5">
                            <!-- Bank Info Card -->
                            <div class="card bank-info-card bg-bottom bg-contain bg-img" style="background-image: url('{{asset('assets/admin-module')}}/img/media/bank-info-card-bg.png');">
                                ...
                                <div class="card-body position-relative">
                                    <img class="bank-card-img" src="{{asset('assets/admin-module')}}/img/media/bank-card.png" alt="">
