                    ...
                    <div class="row mb-4 g-4">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="statistics-card statistics-card__total_provider">
                                ...
                                <img src="{{asset('assets/admin-module')}}/img/icons/subscribed-providers.png" class="absolute-img" alt="">
                            </div>
                            <!-- End Statistics Card -->
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="statistics-card statistics-card__ongoing">
                                ...
                                <img src="{{asset('assets/admin-module')}}/img/icons/onboarding-request.png" class="absolute-img" alt="">
                            </div>
                            <!-- End Statistics Card -->
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="statistics-card statistics-card__newly_joined">
                                ...
                                <img src="{{asset('assets/admin-module')}}/img/icons/newly-joined.png" class="absolute-img" alt="">
                            </div>
                            <!-- End Statistics Card -->
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="statistics-card statistics-card__not_served">
                                ...
                                <img src="{{asset('assets/admin-module')}}/img/icons/not-served.png" class="absolute-img" alt="">
                            </div>
                            <!-- End Statistics Card -->
                        </div>
                    </div>
