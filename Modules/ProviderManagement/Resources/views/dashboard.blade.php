            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="business-summary business-summary-customers">
                        ...
                        <img src="{{asset('assets/provider-module')}}/img/icons/customers.png" class="absolute-img"
                             alt="">
                    </div>
                    <!-- End Business Summary -->
                </div>
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="business-summary business-summary-providers">
                        ...
                        <img src="{{asset('assets/provider-module')}}/img/icons/providers.png" class="absolute-img"
                             alt="">
                    </div>
                    <!-- End Business Summary -->
                </div>
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="business-summary business-summary-services">
                        ...
                        <img src="{{asset('assets/provider-module')}}/img/icons/services.png" class="absolute-img"
                             alt="">
                    </div>
                    <!-- End Business Summary -->
                </div>
                                        ...
                                        <div class="media align-items-center gap-3">
                                            <div class="avatar avatar-lg">
                                                <img class="avatar-img rounded"
                                                     ...
                                                     onerror="this.src='{{asset('assets/provider-module')}}/img/icons/booking.png'"
                                                     alt="">
                                            </div>
                                        ...
                                        <div class="media gap-10">
                                            <div class="avatar avatar-lg">
                                                <img class="avatar-img rounded"
                                                     ...
                                                     onerror="this.src='{{asset('assets/provider-module')}}/img/avatar/activities.png'"
                                                     alt="">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media gap-3">
                                            <div class="avatar avatar-lg">
                                                <img class="object-fit rounded-circle"
                                                     ...
                                                     onerror="this.src='{{asset('assets/provider-module')}}/img/avatar/provider.png'"
                                                     alt="">
                                            </div>
                                            <div class="media-body ">
