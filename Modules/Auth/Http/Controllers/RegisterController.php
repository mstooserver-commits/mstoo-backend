...
class RegisterController extends Controller
{
    ...
    {
        if (!setting_flag(business_live('customer_self_registration', 'customer_config', 1))) {
            return response()->json(response_formatter(REGISTRATION_DISABLED_403), 403);
        }
    ...
    {
        if (!setting_flag(business_live('provider_self_registration', 'service_setup', 0))) {
            abort(403, translate('provider_registration_is_disabled'));
        }
    ...
    {
        if (!setting_flag(business_live('provider_self_registration', 'service_setup', 0))) {
            Toastr::error(translate('provider_registration_is_disabled'));
            return back();
        }
