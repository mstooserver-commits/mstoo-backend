...
Route::group(['prefix' => 'admin', 'as' => 'admin', 'namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        Route::post('login', 'LoginController@admin_login')->middleware('throttle:20,1')->name('login');
    });
...
Route::group(['prefix' => 'provider', 'as' => 'provider', 'namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('login', 'LoginController@provider_login')->middleware('throttle:20,1')->name('login');
    });
...
Route::group(['prefix' => 'customer', 'as' => 'customer', 'namespace' => 'Api\V1'], function () {
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('login', 'LoginController@customer_login')->middleware('throttle:30,1')->name('login');
        Route::post('social-login', 'LoginController@social_customer_login')->middleware('throttle:20,1')->name('social-login');
    });
});
...
Route::group(['prefix' => 'serviceman', 'as' => 'serviceman', 'namespace' => 'Api\V1'], function () {
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        Route::post('login', 'LoginController@serviceman_login')->middleware('throttle:20,1')->name('login');
    });
});
