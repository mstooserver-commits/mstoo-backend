...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'profile_image', 'fcm_token', 'is_phone_verified', 'is_email_verified', 'phone_verified_at', 'email_verified_at', 'password', 'is_active', 'last_login_at', 'provider_id', 'user_type',
        'extra_permissions', 'wallet_balance', 'loyalty_point', 'ref_code', 'referred_by'
    ];
    ...
    public function proMemberships(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(\Modules\ProMemberManagement\Entities\ProMembership::class, 'customer_id');
    }
