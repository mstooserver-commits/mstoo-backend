...
<head>
    ...
    <meta property="og:image" content="@yield('og_image', asset('storage/app/public/landing-page/meta').'/'.bs_data($settings,'meta_image', 1,true))"/>
    <meta property="og:title" content="@yield('og_title', bs_data($settings,'meta_title', 1,true))"/>
    <meta property="og:description" content="@yield('og_description', bs_data($settings,'meta_description', 1,true))">
                ...
                <div class="footer__wrapper">
                                ...
                                @if($settings->where('key_name','app_url_appstore')->first()->is_active??0)
                                    <a href="{{bs_data($settings,'app_url_appstore', 1)}}" class="d-block">
                                        <img class="w-100"
                                            ...
                                            src="{{asset('assets/landing')}}/img/app-btn/app-store.png" alt="">
                                    </a>
                                @endif
                                ...
                                @if($settings->where('key_name','app_url_playstore')->first()->is_active??0)
                                    <a href="{{bs_data($settings,'app_url_playstore', 1)}}" class="d-block">
                                        <img class="w-100"
                                            ...
                                            src="{{asset('assets/landing')}}/img/app-btn/google-play.png" alt="">
                                    </a>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="footer__wrapper-widget">
                        <div class="footer__wrapper-contact">
                            <img class="icon" src="{{asset('assets/landing')}}/img/footer/mail.png" alt="footer">
                            <h6>
                    ...
                    <div class="footer__wrapper-widget">
                        <div class="footer__wrapper-contact">
                            <img class="icon" src="{{asset('assets/landing')}}/img/footer/tel.png" alt="footer">
                            <h6>
                    ...
                    <div class="footer__wrapper-widget">
                        <div class="footer__wrapper-contact">
                            <img class="icon" src="{{asset('assets/landing')}}/img/cta-icon.png" alt="footer">
                            <h6>
