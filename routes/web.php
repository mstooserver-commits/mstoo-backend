...
Route::get('page/blog', [LandingController::class, 'blogs'])->name('page.blog');
Route::get('page/blog/{slug}', [LandingController::class, 'blog_details'])->name('page.blog-details');

// Cache-clearing must never be publicly reachable.
