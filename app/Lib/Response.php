...
const MAINTENANCE_MODE_503 = [
    'response_code' => 'maintenance_mode_503',
    'message' => 'the application is under maintenance'
];

const REGISTRATION_DISABLED_403 = [
    'response_code' => 'registration_disabled_403',
    'message' => 'registration is currently disabled'
];

const PAYMENT_METHOD_DISABLED_403 = [
    'response_code' => 'payment_method_disabled_403',
    'message' => 'this payment method is currently disabled'
];

const BOOKING_CANCEL_DISABLED_403 = [
    'response_code' => 'booking_cancel_disabled_403',
    'message' => 'booking cancellation is currently disabled'
];
const DEFAULT_404 = [
