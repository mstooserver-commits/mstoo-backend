    ...
    function system_permission_catalog(): array
    {
        $special = [
            ...
            'pro_member_management' => [
                'description' => 'Manage Pro membership plans, benefits, members and transactions.',
                'actions' => [
                    'view' => 'View Pro Members',
                    'create' => 'Create Pro Members',
                    'edit' => 'Edit Pro Members',
                    'delete' => 'Delete Pro Members',
                    'manage_benefits' => 'Manage Pro Benefits',
                    'manage_plans' => 'Manage Pro Plans',
                    'manage_settings' => 'Manage Pro Settings',
                    'view_transactions' => 'View Pro Transactions',
                ],
            ],
            'promotion_management' => [
                'description' => 'Banners, coupons, campaigns and push notifications.',
                'actions' => [
